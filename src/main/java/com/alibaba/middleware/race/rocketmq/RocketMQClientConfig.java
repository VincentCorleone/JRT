 ...
 */
public class RocketMQClientConfig implements Serializable {
	...
	protected RocketMQClientConfig(String consumerGroup, String nameServer,
	...
	public RocketMQClientConfig(Map conf) {
	...
	public static RocketMQClientConfig mkInstance(Map conf) {

			return new RocketMQClientConfig(conf);
	}
